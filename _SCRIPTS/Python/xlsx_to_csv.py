...
# CHANGE THESE PARAMETERS TO ALTER THE SCRIPT'S INPUT/OUTPUT BEHAVIOUR
# ======================================================================
# Set root directory (don't forget to include forward slash at the end!)
rootDir = "../Python/"
...
print("\nDone! " + str(n_files) + " file(s) were converted from .xlsx to \
      .csv in " + str(n_folders) + " folder(s)\n")
